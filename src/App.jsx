          ...
          <Route path="/" element={
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
              ...
              <div className="flex gap-4">
                <Link to="/admin/bookings/edit/1" className="text-blue-600 hover:underline">Demo Edit Booking</Link>
                <Link to="/admin/bookings/1/confirm-payment" className="text-blue-600 hover:underline">Demo Confirm Payment</Link>
              </div>
            </div>
          } />
